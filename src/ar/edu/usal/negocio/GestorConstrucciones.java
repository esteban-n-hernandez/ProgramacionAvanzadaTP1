        ...
        if (construccion != null) {
            ...
            try (FileWriter writer = new FileWriter("construcciones/" + fileName + ".txt")) {
                ...
                for (Object object : construccion) {
                    //Uso instance of para comparar el tipo de objeto. Si no es casas, se sabe que va a ser edificios
                    if (object instanceof Casas) {
                        Casas casa = (Casas) object;
                        writer.write(casa + System.lineSeparator());
                    } else {
                        Edificios edificio = (Edificios) object;
                        writer.write(edificio.toString() + System.lineSeparator());
                    }
                }
            } catch (IOException e) {
            ...
            System.out.println("La lista de construccion se encuentra vacia, el archivo no fue creado.");
        }
    }
}